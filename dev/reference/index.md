...
- [`Analyze_OneSideProp()`](https://gilead-public.github.io/gsm.qtl/dev/reference/Analyze_OneSideProp.md)
  **\[stable\]** : Funnel Plot Analysis with Normal Approximation for
  Binary and Rate Outcomes.
- [`Eligibility_Overview()`](https://gilead-public.github.io/gsm.qtl/dev/reference/Eligibility_Overview.md)
  : Eligibility Overview Table
- [`QTL_Overview()`](https://gilead-public.github.io/gsm.qtl/dev/reference/QTL_Overview.md)
  : QTL Overview Table
...
- [`Report_QTL()`](https://gilead-public.github.io/gsm.qtl/dev/reference/Report_QTL.md)
  **\[stable\]** : Report_QTL function
- [`ResultsProcessor()`](https://gilead-public.github.io/gsm.qtl/dev/reference/ResultsProcessor.md)
  : Title
- [`calc_fig_size()`](https://gilead-public.github.io/gsm.qtl/dev/reference/calc_fig_size.md)
...
- [`discontinuation_map_reasons()`](https://gilead-public.github.io/gsm.qtl/dev/reference/discontinuation_map_reasons.md)
  : Filter Discontinuation Reasons in data.frame
- [`discontinuation_reasonBar()`](https://gilead-public.github.io/gsm.qtl/dev/reference/discontinuation_reasonBar.md)
...
- [`eligibility_sourceBar()`](https://gilead-public.github.io/gsm.qtl/dev/reference/eligibility_sourceBar.md)
...
- [`scrollable_gt()`](https://gilead-public.github.io/gsm.qtl/dev/reference/scrollable_gt.md)
